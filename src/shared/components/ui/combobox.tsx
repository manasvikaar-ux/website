...
// biome-ignore lint/performance/noNamespaceImport: React namespace required for ComponentPropsWithRef and useRef
...
import { XIcon } from '@/shared/components/ui/x';
...
const ComboboxClear = ({
  ...
  <ComboboxPrimitive.Clear
    ...
    {...props}
  >
    <XIcon className="pointer-events-none" size={16} />
  </ComboboxPrimitive.Clear>
);
